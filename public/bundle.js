...
/***/ function(module, exports, __webpack_require__) {
	...
	var comp = __webpack_require__(159);

	ReactDOM.render(React.createElement(
	                'div',
	                null,
	                React.createElement(comp.Counter, { imagename: 'fethiye.jpg' }),
	                React.createElement(comp.Counter, { imagename: 'akita.jpg' })
	...
	module.exports.Counter = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { type: "button", onClick: this.plus },
	        "+"
	      ),
	      React.createElement(
	        "button",
	        { type: "button", onClick: this.minus },
	        "-"
	      ),
	      React.createElement("br", null),
	      React.createElement("img", { src: this.props.imagename, height: this.state.ht })
	    );
	  }
	});
